...
class Cart extends Component {
    ...
    //点击全选
    checkedToCheck() {
    //    console.log(this.props.goods.allCheckedTo.flag = !this.props.goods.allCheckedTo.flag)
    //    this.props.goods.getCartChecked({isChecked:this.props.goods.allCheckedTo.flag === true ? 0 : 1 ,productIds})
    }
    render() {
        return (
                ...
                <section className="mains">
                   ...
                   {this.state.flag === false ? <div className='footer'>
                        <div className='footer_checkout' onClick={() => {this.checkedToCheck()}}>
                            {/* <CartImg></CartImg> */}
                            {/* {this.props.goods.allCheckedTo && console.log(this.props.goods.allCheckedTo.flag)} */}
                        ...
                        <div className='footer_order'>下单</div>
                                ...
                                <div className='footer_checkall'>
                                    已选({this.props.goods.cartChecked && this.props.goods.cartChecked.checkedGoodsCount}) 
                                </div>
